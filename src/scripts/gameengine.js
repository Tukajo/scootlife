...
var render = function () {
    ...
    if(currentScreen===50||currentScreen===100){
        ctx.font = "18px Arial";
        ctx.fillStyle = "white";
        bigDialog.x=280;
    ...
    if (currentScreen >= 1) {
        if (currentScreen <= 2 || (currentScreen >= 8 && currentScreen != 11)&&currentScreen!=50&&currentScreen!=100) {
...
function sawReport(){
    ...
    if (mitreSaw_MaxCapacity() < 200) {
        ...
        function paintReport(){
            ctx.fillStyle = "white";
            ctx.font = "20pt Georgia";
            ctx.fillText("Paint Booth", 1150, 100);
            ctx.fillStyle = "black";
            ctx.font = "15pt Georgia"; 
        ...
        function assemblyReport(){
            ctx.fillStyle = "white";
            ctx.font = "20pt Georgia";
            ctx.fillText("Assembly", 1175, 100);
            ctx.fillStyle = "black";
            ctx.font = "15pt Georgia"; 
        ...
        function fabricReport(){
            ctx.fillStyle = "white";
            ctx.font = "20pt Georgia";
            ctx.fillText("Fabric Cutter", 1150, 100);
            ctx.fillStyle = "black";
            ctx.font = "15pt Georgia"; 
